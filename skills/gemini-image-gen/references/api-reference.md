...
Complete technical reference for the Gemini 3.0 Preview Image model API.

## Model Information

**Model Name**: `gemini-3.0-preview-image`
...
**POST** `https://generativelanguage.googleapis.com/v1beta/models/gemini-3.0-preview-image:generateContent`
...
```bash
curl -X POST \
  "https://generativelanguage.googleapis.com/v1beta/models/gemini-3.0-preview-image:generateContent" \
  -H "x-goog-api-key: $GEMINI_API_KEY" \
