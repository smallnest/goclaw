...
description: Guide for implementing Google Gemini API image generation - create high-quality images from text prompts using gemini-3.0-preview-image model. Use when generating images, creating visual content, or implementing text-to-image features. Supports text-to-image, image editing, multi-image composition, and iterative refinement.
license: MIT
version: 1.0.0
allowed-tools:
  - Bash
...
Generate high-quality images using Google's Gemini 3.0 Preview Image model with text prompts, image editing, and multi-image composition capabilities.
...
response = client.models.generate_content(
    model='gemini-3.0-preview-image',
